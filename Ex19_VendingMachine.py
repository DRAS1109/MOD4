"""
O cliente insere o dinheiro para comprar (5€) e o preco do produto(3€) e depois devolve o troco (2€)
"""

import numpy as np

Disponivel = np.array([[2 , 10], [1 , 10] , [0.5 , 10] , [0.2 , 10] , [0.1 , 10] , [0.05 , 10] , [0.02 , 10] , [0.01 , 1000]])
